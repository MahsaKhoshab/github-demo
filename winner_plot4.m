function winner_plot4(winner,pattern)
% close all
% clear 
% clc 
% 
...
%             subplot(mrc+1,max_winner,class); imshow(data_imscale(:,:,j))
            ...
            subaxis(mrc+1,max_winner,1, 'Spacing', 0.01, 'Padding', 0, 'Margin', 0);
            imshow(data_imscale(:,:,1))

            subaxis(mrc+1,max_winner,class, 'Spacing', 0.01, 'Padding', 0, 'Margin', 0);
            imshow(data_imscale(:,:,j))
            break
        else
...
%             subplot(mrc+1,max_winner,t1); imshow(data_imscale(:,:,j))
            ...
            subaxis(mrc+1,max_winner,t1, 'Spacing', 0.01, 'Padding', 0, 'Margin', 0);
            imshow(data_imscale(:,:,j))
